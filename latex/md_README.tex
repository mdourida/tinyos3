...
In its current incarnation, tinyos supports a multicore preemptive scheduler, serial terminal devices, and a unix like process model. It does not support (yet) memory management, block devices, or network devices. These extensions are planned for the future.\hypertarget{md_README_autotoc_md13}{}\doxysection{Quick start}\label{md_README_autotoc_md13}
...
Point your browser at file {\ttfamily doc/html/index.\+html}. Happy reading!\hypertarget{md_README_autotoc_md14}{}\doxysubsection{Build dependencies}\label{md_README_autotoc_md14}
