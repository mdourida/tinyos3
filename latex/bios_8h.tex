...
\#define \mbox{\hyperlink{bios_8h_a009855593b59738d24dbfc236edb3b14}{M\+A\+X\+\_\+\+C\+O\+R\+ES}}~32
...
\#define \mbox{\hyperlink{bios_8h_a4e7d162c7c35103b42768ff4a5c73905}{M\+A\+X\+\_\+\+T\+E\+R\+M\+I\+N\+A\+LS}}~4
...
typedef enum \mbox{\hyperlink{bios_8h_a137af7bce5ff764f5c0aa4550086deaa}{Interrupt}} \mbox{\hyperlink{bios_8h_adae0801dc227f7fab2d61d0b7c9e9643}{Interrupt}}
...
\mbox{\hyperlink{bios_8h_a137af7bce5ff764f5c0aa4550086deaaab4019255561cb4b48789d55c079e1709}{I\+CI}}, 
\mbox{\hyperlink{bios_8h_a137af7bce5ff764f5c0aa4550086deaaac4212312865bd8ac6810b9651d9e80df}{A\+L\+A\+RM}}, 
\mbox{\hyperlink{bios_8h_a137af7bce5ff764f5c0aa4550086deaaa2e06ea796d072595be1770c601e78206}{S\+E\+R\+I\+A\+L\+\_\+\+R\+X\+\_\+\+R\+E\+A\+DY}}, 
\mbox{\hyperlink{bios_8h_a137af7bce5ff764f5c0aa4550086deaaad168539d997c69c61da9c1f5f3187878}{S\+E\+R\+I\+A\+L\+\_\+\+T\+X\+\_\+\+R\+E\+A\+DY}}, 
\newline
{\bfseries maximum\+\_\+interrupt\+\_\+no}
 \}
\begin{DoxyCompactList}\small\item\em The interrupts supported by the C\+PU. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\hyperlink{bios_8h_a91ad9478d81a7aaf2593e8d9c3d06a14}{uint}} \mbox{\hyperlink{bios_8h_aa02a29e5c8a1f4d68413eea0aaa09fba}{cpu\+\_\+cores}} ()
...
void \mbox{\hyperlink{bios_8h_a719b0f9f8854d21436c96931ba1caf59}{cpu\+\_\+ici}} (\mbox{\hyperlink{bios_8h_a91ad9478d81a7aaf2593e8d9c3d06a14}{uint}} \mbox{\hyperlink{structcore}{core}})
...
void \mbox{\hyperlink{bios_8h_ab2be31ceb56ec6919d4d25fe4b2da0c8}{cpu\+\_\+disable\+\_\+interrupts}} ()
...
void \mbox{\hyperlink{bios_8h_a3d9df4f1db5a1d99720f327668726e2b}{bios\+\_\+serial\+\_\+interrupt\+\_\+core}} (\mbox{\hyperlink{bios_8h_a91ad9478d81a7aaf2593e8d9c3d06a14}{uint}} serial, \mbox{\hyperlink{bios_8h_a137af7bce5ff764f5c0aa4550086deaa}{Interrupt}} intno, \mbox{\hyperlink{bios_8h_a91ad9478d81a7aaf2593e8d9c3d06a14}{uint}} \mbox{\hyperlink{structcore}{core}})
...
\+\_\+\+Thread\+\_\+local \mbox{\hyperlink{bios_8h_a91ad9478d81a7aaf2593e8d9c3d06a14}{uint}} \mbox{\hyperlink{bios_8h_abac58ced7d51f54f2318b326bc991933}{cpu\+\_\+core\+\_\+id}}
...
The VM (virtual) hardware is controlled by a B\+I\+OS (Basic I/O System) through the B\+I\+OS A\+PI. We now describe the concepts of the B\+I\+OS in detail.\hypertarget{bios_8h_autotoc_md0}{}\doxysubsubsection{C\+PU}\label{bios_8h_autotoc_md0}
A C\+PU has 1 or more cores. Each core executes independently of each other. Variable cpu\+\_\+core\+\_\+id contains the id number of the current core.\hypertarget{bios_8h_autotoc_md1}{}\doxysubsubsection{Interrupts}\label{bios_8h_autotoc_md1}
...
Each simulated core has its own timer. A timer can be activated by initializing it with some time interval. When the timer expires, the A\+L\+A\+RM interrupt is raised for the core.\hypertarget{bios_8h_autotoc_md4}{}\doxysubsubsection{Serial ports}\label{bios_8h_autotoc_md4}
...
I\+CI&Raised by some core, via \mbox{\hyperlink{bios_8h_a719b0f9f8854d21436c96931ba1caf59}{cpu\+\_\+ici()}} \\
\hline
...
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{bios_8h_ab2be31ceb56ec6919d4d25fe4b2da0c8}{cpu\+\_\+disable\+\_\+interrupts}} 
\end{DoxySeeAlso}
